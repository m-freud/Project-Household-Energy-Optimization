...
MODEL_FEATURE_DOMAIN: dict[str, list[str]] = {
    "EV_STATUS": [ # we dont go as far back here as with the regressors since we only do recursive single step predictions, and far past is less relevant
        "timestep",
        "status",
        "time_sin",
        "time_cos",
    ...
    "BASE_LOAD": [ # lag/ma/std go back up to 48 steps (12h); delta/acc use current - lag_x, capped at lag_16
        ...
        "base_load_lag_16",
        "base_load_lag_16_is_pad",
        "base_load_lag_24",
        "base_load_lag_24_is_pad",
        "base_load_lag_32",
        "base_load_lag_32_is_pad",
        "base_load_lag_48",
        "base_load_lag_48_is_pad",
        "base_load_ma_2",
        "base_load_ma_4",
        "base_load_ma_8",
        "base_load_ma_16",
