...
class Config:
    ...
    TRAIN_SETS = {}
    for _label, _complement_ids in CLEAN_COMPLEMENTS.items():
        TRAIN_SETS[_label] = {}
        for _metric, _extra_ids in EXTRA_IDS.items():
            TRAIN_SETS[_label][_metric] = sorted(set(_complement_ids + _extra_ids))
